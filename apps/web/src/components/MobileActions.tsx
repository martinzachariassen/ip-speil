...
export function MobileActions({ actions }: { actions: PageActions }) {
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-30 flex gap-2 border-line border-t bg-[color-mix(in_oklch,var(--background)_92%,transparent)] px-4 pt-2.5 pb-[max(10px,env(safe-area-inset-bottom))] backdrop-blur-md lg:hidden"
      role="group"
