...
const FIELDS: { label: string; get: (r: Report) => unknown }[] = [
  ...
  { label: "Announced prefix", get: (r) => r.routing?.prefix ?? null },
  { label: "Origin ASN", get: (r) => r.routing?.originAsn ?? null },
  { label: "RPKI state", get: (r) => r.routing?.rpki ?? null },
  ...
  { label: "DNSSEC validated", get: (r) => r.signals?.dnssecValidated ?? null },
